...
namespace ZEROWORLD.Projectiles.Other
{
    ...
    /// 增幅子弹 - 敌对（魔法）
    /// </summary>
    public class ProjectileBusutadanTekitaitekiMajikku : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.active)
            {
                ...
                Dust.NewDust(projectile.Center, projectile.width, projectile.height, 172, (tVEC / -21).X, (tVEC / -21).Y);
                if (tReduce > 0)
                    tReduce--;
